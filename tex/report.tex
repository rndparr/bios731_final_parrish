...
\newcommand{\duedate}{Spring 2026\\\textcolor{blue}{\underline{\href{https://github.com/rndparr/bios731_final_parrish}{GitHub Repo}}}}
...
\input{../tables/summary_report.tex}
...
\caption{Venn Diagrams of Overlapping xWAS Results}
  \includegraphics[trim={0 3.5cm 0 3.5cm},clip,width=0.8\textwidth]{../figs/venn_report.pdf}
  \label{fig:venn}
\end{figure}
...
\begin{figure}[H]\centering
  ...
  \includegraphics[width=\textwidth]{../figs/paths_plot.pdf}
  \label{fig:paths_plot}
\end{figure}

\begin{figure}[H]\centering
	\caption{Venn Diagram of Number of Overlapping Paths for each xWAS}
  \includegraphics[trim={0 3.5cm 0 3.5cm},clip,width=0.8\textwidth]{../figs/paths_venn_report.pdf}
...
\input{../tables/overlap_paths.tex}
...
\input{../tables/cis-TWAS_sig_genes.tex}

\input{../tables/cistrans-TWAS_sig_genes.tex}

\input{../tables/cis-PWAS_sig_genes.tex}

\input{../tables/cistrans-PWAS_sig_genes.tex}
